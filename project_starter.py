...
def build_multi_agent_system() -> CodeAgent:
    ...
    orchestrator = CodeAgent(
        ...
        instructions=(
            ...
            "  5. Return a single customer-facing message that includes: the "
            "itemised quote with discount applied, the delivery commitment, "
            "and a one-sentence rationale. Never reveal internal cash, "
            "supplier costs, or other items the customer didn't ask about.\n"
